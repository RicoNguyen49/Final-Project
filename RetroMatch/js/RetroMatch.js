var IMG1Array = [
    { name: 'Sunset', img: 'RetroMatch/media/sunsetpixel.png'}, 
    { name: 'Storm', img: 'RetroMatch/media/storm.png'}, 
    { name: 'island', img: 'RetroMatch/media/islandPixel.jpg'},
    { name: 'jungle', img: 'RetroMatch/media/jungle.jpg'}, 
    { name: 'Space', img: 'RetroMatch/media/pixelspace.png'}, 
    { name: 'lake', img: 'RetroMatch/media/pixelLake.png'},
    { name: 'city', img: 'RetroMatch/media/city.jpg'}, 
    { name: 'diamond', img: 'RetroMatch/media/diamond.jpg'}
  ];
...
correct.src = 'RetroMatch/media/correct.wav';

var flip = new Audio();
flip.src = 'RetroMatch/media/flipsound.wav';

var victory = new Audio();
victory.src = 'RetroMatch/media/Victory.wav';
...
grid.addEventListener('click', event => {
  ...
  if (count < 2) {
    ...
    // if correctCount is 8, the number of pairs. The game has been won
    if(correctCount == 8){
      setTimeout(win, 2000);
    }
